...
public class RentalController {
    ...
    @PatchMapping("/return")
    public ResponseEntity<ApiResponse<RentalUpdateResponse>> updateRental(@AuthenticationPrincipal AuthUser authUser,
                                                                          @RequestBody @Valid RentalUpdateRequest request) {
        RentalUpdateResponse response = rentalInternalService.returnRental(request, authUser.getId());
